...
LABELS = {
    ...
    # NHL Edge (glossary family keys - supplemental tracking, never a card box)
    "edge_save_pct": "Save % by zone (NHL Edge)",
    "edge_counts": "Saves / shots / goals against (NHL Edge)",
    "pct_starts_over_900": "% of starts over .900 (NHL Edge)",
    "edge_5v5_save_pct": "5-on-5 save % (NHL Edge)",
    "hardest_shot": "Hardest shot (NHL Edge)",
    "avg_shot_speed": "Average shot speed (NHL Edge)",
    "max_skating_speed": "Max skating speed (NHL Edge)",
    "most_miles_per_game": "Most miles skated, game (NHL Edge)",
    "edge_shots_on_goal": "Shots on goal by zone (NHL Edge)",
    "zone_time": "Zone time (NHL Edge)",
    "zone_starts": "Zone starts (NHL Edge)",
    "skating_speed_bursts": "Skating speed bursts (NHL Edge)",
    "shot_attempt_differential": "Shot attempt differential (NHL Edge)",
    "shot_speed_range_totals": "Shot-speed range totals (NHL Edge)",
}
